...
const ComputeInstanceSidePanel = () => {
  ...
  const availableOptions = useMemo(() => {
    ...
    return availableAddons.find((addon) => addon.type === 'compute_instance')?.variants ?? []
          ...
          <div className="py-6 space-y-4">
            {selectedProject?.infra_compute_size === 'nano' && subscription?.plan.id !== 'free' && (
              <Alert_Shadcn_ variant="default">
                ...
                <AlertDescription_Shadcn_>
                  Your project is still on the free plan compute. Paid plans allows you to upgrade
                  to Micro compute for no additional charges.
                </AlertDescription_Shadcn_>
              </Alert_Shadcn_>
            )}
